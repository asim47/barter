...
const CategoryModal = ({ open, setModalOpen, type }) => {
  ...
  async function Search1() {
    ...
    if (!SelectedPicker1 && !SelectedPicker2 && !FieldOne) {
      dispatch(Actions.settingCategoryDatas("keyword", "")),
        dispatch(Actions.settingCategoryDatas("selectedCategoryID", "")).then(() => {
    ...
    Promise.all([
      dispatch(Actions.settingCategoryDatas("keyword", FieldOne)),
      dispatch(Actions.settingCategoryDatas("selectedCategoryID", `${SelectedPicker1}${SelectedPicker2 ? `,${SelectedPicker2}` : ""}`))
    ]).then(() => {
      dispatch(Actions.GettingChildrenCategories())
      setModalOpen(false)
    })
            ...
            <View style={{ height: '100%', width: '80%' }}>
              ...
              <View
                ...
                <ClickAbleByAsim
                  onPress={() => {
                    if (Search) {
                      dispatch(Actions.settingCategoryDatas("distance", parseInt(Search))).then(() => {
                        dispatch(Actions.GettingChildrenCategories())
                      })
                      setModalOpen(false)
                    } else {
                      dispatch(Actions.settingCategoryDatas("distance", parseInt(0))).then(() => {
                        dispatch(Actions.GettingChildrenCategories())
                        setModalOpen(false)
                      })
                    }
              ...
              <View
                ...
                <RNPickerSelect
                  ...
                  onValueChange={value => {
                    ...
                    dispatch(Actions.settingCategoryDatas("condition", value)).then(() => {
                      dispatch(Actions.GettingChildrenCategories())
                      setModalOpen(false)
                    })
                  }}
            ...
            <View
              ...
              <View
                ...
                <RNPickerSelect
                  ...
                  onValueChange={value => {
                    setSortBy(value)
                    dispatch(Actions.settingCategoryDatas("sortBy", value)).then(() => {
                      dispatch(Actions.GettingChildrenCategories())
                      setModalOpen(false)
                    })
                  }}
